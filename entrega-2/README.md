...
- Cabeçalho ```"NAME_OF_FILE: "```: É um cabeçalho escrito somente no componente de mensagem e enviado junto do nome do arquivo mais sua extensão. Ele serve para indicar ao destinatário o recebimento de um novo arquivo. Antes de cada arquivo enviado, é enviado seu nome nesse cabeçalho.
